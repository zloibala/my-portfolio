    ...
    <div className="about__me__container">
      <div className="text__container">
        ...
        <p style={{ color: 'white', textAlign: 'center', width: '700px' }}>
          ...
          cosmos for a stellar 3 years. When I'm not battling bugs or diving deep into the realms of
          CSS and JavaScript, you'll often find me juggling pixels like a circus performer or
          brainstorming user experiences with a mischievous twinkle in my eye. I believe in creating
          designs that not only look out-of-this-world but also bring joy and usability to the
          digital galaxy.
          <p />
          <br />
          <p>
            <span className="highlight"> In my cosmic quest </span>for the perfect user interface,
            I've mastered the art of making
            <span className="highlight"> websites sing and</span> dance, all while keeping users on
            the edge of their seats. My mission?{' '}
            <span className="highlight"> To make the online</span> world a brighter, more intuitive
